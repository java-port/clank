FILE_NAME = StdVectorShort
CLASS_SUFFIX =
MAIN_CLASS = std.vectorShort
TYPE = short
BOXED_TYPE = Short
ARRAY_TYPE = short
NEW_ZERO_ARRAY = new$short(0)
COPY_OF_ARRAY = copyOf$short
...
ITERATOR_INTERFACE = short$iterator<iterator>
...
ELEMENT_BOOL_PREDICATE=NativeCallback.ShortBoolPredicate
