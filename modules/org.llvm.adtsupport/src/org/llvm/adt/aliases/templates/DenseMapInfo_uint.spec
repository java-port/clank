FILE_NAME = DenseMapInfoUInt
CLASS_SUFFIX =
IMPLEMENTS_DENSE_MAP_INFO=
TYPE_SUFFIX =
JAVA_CLASS_DESCRIPTION=DenseMapInfo<unsinged int>
TYPE = /*uint*/int
RAW_TYPE = /*uint*/int
EXTRA_ASSERT_FOR_EMPTY_TOMBSTONE_KEYS=
COMMENT_ALT=//
DEFAULT_EMPTY_KEY=~0/*U*/
DEFAULT_TOMBSTONE_KEY=~0/*U*/-1
DEFAULT_HASH_VALUE_IMPL=return (Key * 37/*U*/);
