...
VECTOR_TYPE = std.vector<std.pairTypeType<KeyT, ValueT>>
VECTOR_ITER = std.vector.iterator<std.pairTypeType<KeyT, ValueT> >
VECTOR_REVERSE_ITER = std.reverse_iterator<std.pairTypeType<KeyT, ValueT>>
VECTOR_PAIR = std.pairTypeType<KeyT, ValueT>
KEY_TYPE = KeyT
VALUE_TYPE = ValueT
