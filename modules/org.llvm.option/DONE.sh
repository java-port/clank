...
${SPUTNIK}/contrib/JConvert/jclank.sh -java-options=${SPUTNIK}/modules/org.llvm.option/llvmToClangType ${LLVM_SRC}/llvm/lib/Option/OptTable.cpp "-nm=_ZL11matchOptionPKN4llvm3opt8OptTable4InfoENS_9StringRefEb;_ZL17getOptionHelpNameRKN4llvm3opt8OptTableENS0_12OptSpecifierE;_ZL18getOptionHelpGroupRKN4llvm3opt8OptTableENS0_12OptSpecifierE;_ZL19PrintHelpOptionListRN4llvm11raw_ostreamENS_9StringRefERSt6vectorISt4pairISsPKcESaIS7_EE;_ZL7isInputRKN4llvm9StringSetINS_15MallocAllocatorEEENS_9StringRefE;" -static-type=OptTableStatics -package=org.llvm.option.impl > ${SPUTNIK}/modules/org.llvm.option/src/org/llvm/option/impl/OptTableStatics.java
