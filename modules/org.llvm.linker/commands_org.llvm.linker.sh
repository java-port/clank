...
${SPUTNIK}/contrib/JConvert/jclank.sh -empty-body -java-options=${SPUTNIK}/modules/org.llvm.linker/llvmToClangType ${LLVM_SRC}/llvm/lib/Linker/IRMover.cpp "-nm=_ZL12mergeTriplesB5cxx11RKN4llvm6TripleES2_;_ZL12triplesMatchRKN4llvm6TripleES2_;_ZL13forceRenamingPN4llvm11GlobalValueENS_9StringRefE;_ZL16getArrayElementsPKN4llvm8ConstantERNS_15SmallVectorImplIPS0_EE;" -static-type=IRMoverStatics -package=org.llvm.linker.impl > ${SPUTNIK}/modules/org.llvm.linker/src/org/llvm/linker/impl/IRMoverStatics.java
${SPUTNIK}/contrib/JConvert/jclank.sh -empty-body -java-options=${SPUTNIK}/modules/org.llvm.linker/llvmToClangType ${LLVM_SRC}/llvm/lib/Linker/LinkModules.cpp "-nm=_Z16LLVMLinkModules2;_ZL16getMinVisibilityN4llvm11GlobalValue15VisibilityTypesES1_;" -static-type=LinkModulesStatics -package=org.llvm.linker.impl > ${SPUTNIK}/modules/org.llvm.linker/src/org/llvm/linker/impl/LinkModulesStatics.java
